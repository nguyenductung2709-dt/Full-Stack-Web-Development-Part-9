import { Gender, Patient } from "../src/types/patientTypes";
...
const patientsEntriesNew: Patient[] = patients.map(obj => {
    const patient = toNewPatientsEntry(obj) as Patient;
    patient.id = obj.id;
    return patient;
});

export default patientsEntriesNew;